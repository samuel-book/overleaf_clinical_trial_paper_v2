...
\begin{figure}[!h]
    \centering%\captionsetup{width=.8\linewidth}%
      \includegraphics[width=0.95\linewidth]{./images_main/thrombolysis_dag.png}\\
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \includegraphics[trim={0 0 0 1.2cm}, clip, width=1\textwidth]{./images_main/083_xgb_7_features_5fold_binary_shap_violin_mrs1_0kfold}\\
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.45\textwidth]{./images_main/103_xgb_7_features_1fold_binary_improvement_logodds_mrs0_1_sns_subplots_ivt_shap_paper}\\
...
\begin{table}[!ht]
    ...
    Linear regression of the change in thrombolysis contribution to excellent outcome at discharge as a function of onset-to-treatment time (OTT), stratified by stroke severity (mild-moderate: NIHSS 0–10; severe: NIHSS 11+).
    \centering
